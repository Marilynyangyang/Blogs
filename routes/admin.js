...
admin.get('/blog', require('../controller/admin/blogs_page')); //展示博客列表
admin.get('/blog-edit', require('../controller/admin/blog_info')); //创建博客的信息页面
admin.post('/blog-add', require('../controller/admin/blog_add')) //实现博客添加功能
