  ...
  return regeneratorRuntime.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, username = _req$body.username, email = _req$body.email, role = _req$body.role, state = _req$body.state, password = _req$body.password;
          id = req.query.id; //将要修改的用户id
          _context.next = 4;
